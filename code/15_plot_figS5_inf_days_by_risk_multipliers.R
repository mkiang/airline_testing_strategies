...
p1 <- dplyr::filter(plot_df,
    ...
    ggplot2::facet_grid(risk_multi_cat ~ testing_cat,
                        scales = "free") +
...
ggplot2::ggsave(
    "./plots/figS5_cume_infdays_by_risk_multi.pdf",
    p1,
...
ggplot2::ggsave(
    "./plots/figS5_cume_infdays_by_risk_multi.jpg",
    p1,
    dpi = 300,
    width = 9,
    height = 9,
